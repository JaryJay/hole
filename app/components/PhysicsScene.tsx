...
function Scene({
  ...
  return (
    <>
      ...
      <PineTree position={[1, 0, 3]} onDespawn={onObjectDespawn} />
      <PineTree position={[2, 0, 6]} onDespawn={onObjectDespawn} />
      <LargeTree position={[-1, 0, -7]} onDespawn={onObjectDespawn} />
      <LargeTree position={[-4, 0, -2]} onDespawn={onObjectDespawn} />
    </>
  );
}
